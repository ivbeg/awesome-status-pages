...
* [Peekaping](https://github.com/0xfurai/peekaping) - Modern self-hosted uptime monitoring with real-time dashboard, multi-channel notifications, status pages, and analytics.
