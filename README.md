...
* * [isitdownstatus](https://isitdownstatus.com) - Free JSON API to check real-time status of 90+ services. Combines crowd reports with official status pages. No auth required, CORS enabled.
